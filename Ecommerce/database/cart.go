...
var (
	...
	//Error messages for certain functions when using the program
...
func AddProductToCart(ctx context.Context, prodCollection, userCollection *mongo.Collection, productID primitive.ObjectID, userID string)error {
	//How to get a product from the data base
	...
	// Slice of of a type models.product user from my struct
...
func RemoveCartItem(ctx context.Context, prodCollection, userCollection *mongo.Collection, productID primitive.ObjectID, userID string) error{
	...
	//how to remove product from data 
...
func BuyItemFromCart(ctx context.Context, userCollection *mongo.Collection, userID string) error{
	...
	//added items in the cart to the order list
	//empty up the cart
...
func InstantBuy(ctx context.Context, prodCollection, userCollection *mongo.Collection, productID primitive.ObjectID, userID string)error{
	...
	// line of code to find the Price of a product the user requested
	order_detail.Price = product_details.Price

	//how to add producer to user order
	filter := bson.D{primitive.E{Key: "_id", Value: id}}
	...
	//How to add details to the order list
	filter2 := bson.D{primitive.E{Key:"_id", Value: id}}
